  ...
  return (
    <div className="flex flex-col items-center px-4 pt-12 pb-6">
      ...
      <div className="flex flex-wrap items-center justify-center gap-2 mb-3 animate-fade-in-up">
        <Badge className="bg-gradient-to-r from-royal to-electric dark:from-blue-500 dark:to-blue-700 text-white border-none rounded-full px-3 py-1 shadow-md">
      ...
      <div className="text-center space-y-3 mb-4">
        <p className="text-blue-600 dark:text-blue-400 font-medium text-sm uppercase bg-gradient-to-r from-royal to-electric bg-clip-text text-transparent dark:from-blue-400 dark:to-blue-500">
        ...
        <div className="w-20 h-1 bg-gradient-to-r from-royal to-electric dark:from-blue-400 dark:to-blue-500 rounded-full mb-3 mx-auto"></div>
      </div>
      ...
      <div className="flex flex-col gap-3 w-full mb-4">
        <Button 
          className="group bg-gradient-to-r from-royal to-electric hover:from-blue-700 hover:to-indigo-600 dark:from-blue-500 dark:to-blue-700 text-white rounded-full py-3 text-base shadow-lg hover:shadow-xl transition-all duration-300 w-full justify-center"
          asChild
        >
        ...
        <Button 
          variant="outline" 
          className="border-2 border-blue-200 dark:border-blue-800 text-blue-600 dark:text-blue-400 hover:bg-blue-50 dark:hover:bg-blue-900/30 rounded-full py-3 text-base backdrop-blur-sm shadow-md hover:shadow-lg w-full justify-center"
          asChild
        >
