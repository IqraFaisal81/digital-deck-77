...
const ContactSection = () => {
  ...
  return (
    <section id="contact" className="py-20 bg-gradient-to-br from-purple-50 via-indigo-100 to-royal dark:from-purple-950/20 dark:via-indigo-950/40 dark:to-gray-900 relative overflow-hidden">
      {/* Background Effects */}
