          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div className="bg-black/20 backdrop-blur-sm rounded-xl p-6 border border-white/10">
              ...
              <div className="flex gap-4">
                <a href="https://github.com" target="_blank" rel="noopener noreferrer" className="bg-black/30 p-3 rounded-full hover:bg-blue-500/20 transition-colors">
                  <Github size={20} className="text-white" />
                </a>
                <a href="https://www.linkedin.com/in/iqra-faisal-b6687919b/" target="_blank" rel="noopener noreferrer" className="bg-black/30 p-3 rounded-full hover:bg-blue-500/20 transition-colors">
