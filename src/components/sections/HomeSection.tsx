          ...
          <div className="flex flex-col lg:flex-row w-full items-center justify-between gap-12 px-4 sm:px-6 md:px-8 py-20 max-w-7xl mx-auto">
            ...
            <div className="flex flex-col space-y-8 w-full lg:w-1/2 text-center lg:text-left order-2 lg:order-1">
              ...
              <div className="flex flex-wrap items-center justify-center lg:justify-start gap-4 animate-fade-in-up">
                ...
                <div className="flex items-center gap-2 bg-white/10 backdrop-blur-sm rounded-full px-3 py-1 border border-white/20">
                  ...
                  <span className="text-white/90 text-sm">Online Now</span>
                </div>
              </div>
              ...
              <div className="space-y-6">
                <div className="space-y-4">
                  <p className="text-blue-400 font-semibold tracking-widest uppercase text-sm animate-fade-in-up animate-delay-100">
                ...
                <p className="text-lg text-gray-300 leading-relaxed max-w-xl mx-auto lg:mx-0 animate-fade-in-up animate-delay-300">
              ...
              <div className="flex flex-col sm:flex-row gap-4 animate-fade-in-up animate-delay-400 justify-center lg:justify-start">
                ...
                <Button 
                  size="lg" 
                  variant="outline" 
                  className="border-2 border-white/30 text-white hover:bg-white/10 backdrop-blur-sm rounded-full px-8 py-6 text-lg font-semibold shadow-xl hover:shadow-2xl transition-all duration-300"
                  asChild
                >
              ...
              <div className="grid grid-cols-2 lg:grid-cols-3 gap-4 pt-8 animate-fade-in-up animate-delay-500">
                ...
                <div className="bg-white/5 backdrop-blur-sm rounded-2xl p-4 border border-white/10 hover:bg-white/10 transition-all duration-300 col-span-2 lg:col-span-1">
            ...
            <div className="flex justify-center items-center w-full lg:w-1/2 order-1 lg:order-2 animate-fade-in-up">
              <div className="relative">
                ...
                {/* Profile container */}
                <div className="relative w-80 h-80 lg:w-96 lg:h-96 bg-gradient-to-br from-white/10 to-white/5 backdrop-blur-sm rounded-full border border-white/20 shadow-2xl flex items-center justify-center hover:scale-105 transition-transform duration-500">
                  <Avatar className="w-72 h-72 lg:w-88 lg:h-88 rounded-full border-4 border-white/30 shadow-2xl">
                    <AvatarImage
