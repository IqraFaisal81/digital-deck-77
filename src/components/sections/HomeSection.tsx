...
const HomeSection = () => {
  return (
    <BackgroundGradientAnimation 
      ...
      gradientBackgroundEnd="rgb(240, 244, 255)"
      firstColor="21, 101, 192"
      secondColor="99, 169, 247"
      thirdColor="46, 134, 222"
      fourthColor="21, 101, 192"
      fifthColor="30, 64, 175"
      pointerColor="66, 99, 235"
      blendingValue="soft-light"
      containerClassName="min-h-screen"
    >
      <section id="home" className="min-h-screen flex items-center justify-center pt-16 pb-20 overflow-hidden relative">
