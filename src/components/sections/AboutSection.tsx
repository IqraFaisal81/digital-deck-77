...
const AboutSection = () => {
  return (
    <section id="about" className="py-16 lg:py-20 relative overflow-hidden bg-gradient-to-b from-slate-50 via-white to-blue-50 dark:from-gray-900 dark:via-gray-800 dark:to-blue-950">
      {/* Background Elements */}
