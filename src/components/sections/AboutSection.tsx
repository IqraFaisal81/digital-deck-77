...
const AboutSection = () => {
  return (
    <section id="about" className="py-16 lg:py-20 relative overflow-hidden bg-gradient-to-b from-slate-50 via-white to-blue-50 dark:from-purple-950 dark:via-gray-900 dark:to-purple-900">
      {/* Background Elements */}
