...
const AboutSection = () => {
  return (
    <section id="about" className="py-16 lg:py-20 relative overflow-hidden bg-gradient-to-br from-slate-50 via-white to-blue-50 dark:from-gray-900 dark:to-gray-850">
      {/* Background Elements */}
