  ...
  return (
    ...
    >
      <div className="container mx-auto px-4">
        <h2 className="text-3xl md:text-4xl font-bold mb-6 text-center text-gray-900">Workflow Automations</h2>
        ...
        <div className="bg-white shadow-md rounded-xl p-6 border border-gray-200 mb-8">
          <h3 className="text-xl font-semibold mb-4 text-blue-600">What I Automate:</h3>
        ...
        <h3 className="text-xl font-semibold mb-4 text-center text-gray-900">Workflow Examples</h3>
        <WorkflowCarousel />
        
        <div className="mt-8 bg-blue-50 rounded-xl p-6 border border-blue-100">
          <h3 className="text-xl font-semibold mb-4 text-center text-blue-600">Real Results I've Delivered</h3>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
