    ...
    >
      <div className="relative w-full">
        <a 
          ...
          className="bg-gray-200 h-28 w-full rounded-xl shadow-md border border-gray-300 flex items-center justify-center p-4 transition-all duration-300 hover:shadow-lg hover:border-blue-500 group"
        >
