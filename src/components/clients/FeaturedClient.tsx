...
const FeaturedClient: React.FC = () => {
  return (
    <div className="bg-white shadow-md shadow-red-900/10 rounded-2xl border border-black/10 p-8 mb-16">
      <div className="flex flex-col md:flex-row gap-8 items-center">
        <div className="md:w-1/3">
          <img 
            src="/lovable-uploads/afd512f8-af6f-4adb-bb3e-ed3b41ed3d11.png" 
            alt="Grey Matters Featured Client" 
            className="max-w-full h-auto rounded-xl bg-white p-6 shadow-sm shadow-red-900/10"
          />
        </div>
        <div className="md:w-2/3">
          ...
          <blockquote className="italic text-black border-l-4 border-black pl-4 my-4">
            ...
            <footer className="text-black/70 mt-2">— Director, Grey Matters Studio</footer>
          </blockquote>
        </div>
      </div>
    </div>
