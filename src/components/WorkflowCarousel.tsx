      ...
      >
        <CarouselContent>
          {workflows.map((workflow) => (
            <CarouselItem key={workflow.id} className="basis-full md:basis-1/2 lg:basis-1/3">
              <div 
                className="workflow-card cursor-pointer h-full"
              ...
              >
                ...
                <div className="p-4">
                  <h4 className="text-lg font-semibold text-white">{workflow.title}</h4>
