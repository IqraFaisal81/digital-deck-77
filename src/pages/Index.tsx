...
const Index = () => {
  ...
  const scrollToSection = (sectionId: string | null) => {
    ...
    if (sectionId === "workflows" && workflowsRef.current) {
      workflowsRef.current.scrollIntoView({
        behavior: "smooth"
      });
    } else if (sectionId === "seo-audits" && seoAuditsRef.current) {
      seoAuditsRef.current.scrollIntoView({
        behavior: "smooth"
      });
    }
  };
  ...
  return <div className="min-h-screen bg-blue-gradient text-white overflow-x-hidden">
      <Navbar />
        ...
        <div className="container mx-auto">
          <div className="flex flex-col items-center text-center">
            <div className="relative w-32 h-32 mb-6 rounded-full overflow-hidden shadow-lg animate-fade-in">
              <img src="/lovable-uploads/934937cb-710e-4f8e-aa1e-757407b8a2ab.png" alt="Iqra Faisal" className="w-full h-full object-cover" />
            </div>
            ...
            <div className="flex flex-col sm:flex-row gap-4 animate-fade-in">
              <Button size="lg" className="bg-electric hover:bg-electric/80 text-white" asChild>
      ...
      <section id="services" className="section-padding">
        <div className="container mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {services.map(service => <div key={service.id} className={`service-card ${service.sectionId ? 'cursor-pointer hover:bg-black/20' : ''}`} onClick={() => scrollToSection(service.sectionId)}>
                ...
                {service.sectionId && <div className="mt-3 text-electric text-sm flex items-center">
          ...
          <div className="bg-black/20 backdrop-blur-sm rounded-xl p-6 border border-white/10 mb-12">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="p-4 bg-black/30 rounded-lg">
                <h4 className="font-semibold mb-2">PPC, Analytics &amp; Tracking Suite</h4>
      ...
      <section id="projects" className="section-padding">
        <div className="container mx-auto">
          ...
          {projectCategories.map(category => <div key={category} className="mb-20">
              <h3 className="text-2xl font-semibold mb-8 pl-4 border-l-4 border-electric">
                {category}
              </h3>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                {getProjectsByCategory(category).map(project => <div key={project.id} className="project-card cursor-pointer" onClick={() => openProjectModal(project)}>
        ...
        <ProjectModal project={selectedProject} isOpen={modalOpen} setIsOpen={setModalOpen} />
      </section>
        ...
        <div className="container mx-auto">
          ...
          <div className="bg-black/20 backdrop-blur-sm rounded-xl p-8 border border-white/10 max-w-4xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-10">
              <a href="mailto:iqrafaisal81@gmail.com" className="flex items-center justify-center md:justify-start gap-3 p-4 bg-black/30 rounded-lg hover:bg-black/40 transition-colors">
                <Mail className="text-electric" />
                <span>iqrafaisal81@gmail.com</span>
              </a>
              <a href="tel:+447555859390" className="flex items-center justify-center md:justify-start gap-3 p-4 bg-black/30 rounded-lg hover:bg-black/40 transition-colors">
                <Phone className="text-electric" />
                <span>+44 7555 859390 | +92 331 0043676</span>
              </a>
              <a href="https://linkedin.com" target="_blank" rel="noopener noreferrer" className="flex items-center justify-center md:justify-start gap-3 p-4 bg-black/30 rounded-lg hover:bg-black/40 transition-colors">
                <Linkedin className="text-electric" />
                <span>LinkedIn</span>
                <ExternalLink size={14} className="ml-auto" />
              </a>
              <a href="https://github.com" target="_blank" rel="noopener noreferrer" className="flex items-center justify-center md:justify-start gap-3 p-4 bg-black/30 rounded-lg hover:bg-black/40 transition-colors">
