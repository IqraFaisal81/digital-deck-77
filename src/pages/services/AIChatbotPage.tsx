              ...
              <div className="flex items-center mb-6">
                ...
                <div>
                  <h1 className="text-3xl font-bold bg-gradient-to-r from-gray-900 to-blue-800 dark:from-white dark:to-blue-200 bg-clip-text text-transparent">
                    AI Chatbot & Voice Solutions
                  </h1>
                  <p className="text-gray-600 dark:text-gray-300">Intelligent conversational AI systems</p>
                </div>
              </div>
              
              <div className="prose max-w-none mb-8">
                <p className="text-lg text-gray-700 dark:text-gray-300 mb-6">
                  Deploy intelligent conversational AI systems that provide instant customer support, qualify leads, and handle inquiries with natural language processing and voice capabilities.
                </p>
                
                <h3 className="text-xl font-semibold mb-4">What's Included:</h3>
                <ul className="space-y-2 text-gray-700 dark:text-gray-300">
                  <li>• Custom AI chatbot development</li>
                  <li>• Natural language processing setup</li>
