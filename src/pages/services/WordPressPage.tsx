          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-xl p-8 md:p-12">
              <div className="flex items-center mb-6">
                <div className="p-4 rounded-2xl bg-gradient-to-br from-cyan-500 to-blue-500 shadow-xl mr-6">
                ...
                <div>
                  ...
                  <p className="text-gray-600 dark:text-gray-300">Custom WordPress solutions for your business</p>
                </div>
              </div>
              
              <div className="prose max-w-none mb-8">
                <p className="text-lg text-gray-700 dark:text-gray-300 mb-6">
                  Build powerful, custom WordPress websites with theme development, plugin customization, WooCommerce integration, and performance optimization for fast, secure, and scalable sites.
                </p>
                
                <h3 className="text-xl font-semibold mb-4">What's Included:</h3>
                <ul className="space-y-2 text-gray-700 dark:text-gray-300">
                  <li>• Custom theme development and design</li>
                  <li>• Plugin development and customization</li>
                  <li>• WooCommerce store setup and optimization</li>
                  <li>• Performance optimization and speed tuning</li>
                  <li>• Security hardening and maintenance</li>
                  <li>• SEO optimization and schema markup</li>
