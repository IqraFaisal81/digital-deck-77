          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-xl p-8 md:p-12">
              <div className="flex items-center mb-6">
                <div className="p-4 rounded-2xl bg-gradient-to-br from-yellow-500 to-orange-500 shadow-xl mr-6">
                ...
                <div>
                  ...
                  <p className="text-gray-600 dark:text-gray-300">Powerful workflow automation and integration</p>
                </div>
              </div>
              
              <div className="prose max-w-none mb-8">
                <p className="text-lg text-gray-700 dark:text-gray-300 mb-6">
                  Connect and automate your favorite apps with powerful Zapier workflows that eliminate manual tasks, sync data seamlessly, and create intelligent business process automation.
                </p>
                
                <h3 className="text-xl font-semibold mb-4">What's Included:</h3>
                <ul className="space-y-2 text-gray-700 dark:text-gray-300">
                  <li>• Custom Zapier workflow development</li>
                  <li>• Multi-app integration setup</li>
                  <li>• Data synchronization automation</li>
                  <li>• Trigger and action optimization</li>
