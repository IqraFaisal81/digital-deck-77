...
import { Calendar, ArrowLeft, Workflow } from 'lucide-react';
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-xl p-8 md:p-12">
              <div className="flex items-center mb-6">
                <div className="p-4 rounded-2xl bg-gradient-to-br from-orange-500 to-red-500 shadow-xl mr-6">
                  <Workflow className="text-white h-8 w-8" />
                </div>
                <div>
                  ...
                  <p className="text-gray-600 dark:text-gray-300">Professional website development and design</p>
                </div>
              </div>
              
              <div className="prose max-w-none mb-8">
                <p className="text-lg text-gray-700 dark:text-gray-300 mb-6">
                  Build stunning, responsive websites and web applications using Webflow's powerful visual development platform with custom interactions, animations, and CMS integration.
                </p>
                
                <h3 className="text-xl font-semibold mb-4">What's Included:</h3>
                <ul className="space-y-2 text-gray-700 dark:text-gray-300">
                  <li>• Custom Webflow website design</li>
                  <li>• Responsive development across all devices</li>
                  <li>• Custom interactions and animations</li>
                  <li>• CMS setup and content management</li>
