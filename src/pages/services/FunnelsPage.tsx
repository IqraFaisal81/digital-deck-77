          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-xl p-8 md:p-12">
              <div className="flex items-center mb-6">
                <div className="p-4 rounded-2xl bg-gradient-to-br from-purple-500 to-pink-500 shadow-xl mr-6">
                  <Repeat className="text-white h-8 w-8" />
                </div>
                <div>
                  ...
                  <p className="text-gray-600 dark:text-gray-300">High-converting sales funnel design</p>
                </div>
              </div>
              
              <div className="prose max-w-none mb-8">
                <p className="text-lg text-gray-700 dark:text-gray-300 mb-6">
                  Design and build high-converting sales funnels for onboarding, e-commerce, and lead capture that not only look stunning but drive measurable results and maximize conversion rates.
                </p>
                
                <h3 className="text-xl font-semibold mb-4">What's Included:</h3>
                <ul className="space-y-2 text-gray-700 dark:text-gray-300">
                  <li>• Custom funnel strategy and design</li>
